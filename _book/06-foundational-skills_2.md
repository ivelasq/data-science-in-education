...
![(\#fig:fig6-1)Image of the Packages pane, which is found in the bottom right corner of the RStudio IDE, along with the Files, Plots, Help, and Viewer panes](./man/figures/Figure 6.1.png)
...
![(\#fig:fig6-2)Error message when running ?mutate](./man/figures/Figure 6.2.png)
...
![(\#fig:fig6-3)Example from the `coalesce()` Help documentation](./man/figures/Figure 6.3.png)
...
![(\#fig:fig6-4)List of attached packages and associated conflicts when loading the Tidyverse](./man/figures/Figure 6.4.png)
...
![(\#fig:fig6-5)Loading the `ma_data` Dataset](./man/figures/Figure 6.5.png)
...
![(\#fig:fig6-6)The Treachery of Images by Magritte](./man/figures/Figure 6.6.png)
